package org.solenopsis.lasius.wsimport.tooling.util;
...
import org.solenopsis.lasius.wsimport.tooling.security.ToolingSecurityMgr;
 ...
 *
 */
public final class ToolingWebServiceUtil {

    /**
     * Our logger.
     */
    private static final Logger logger = Logger.getLogger(ToolingWebServiceUtil.class.getName());
     ...
     */
    public static final SecurityMgr DEFAULT_SECURITY_MGR = new ToolingSecurityMgr();

    /**
     * Create an tooling port. You will be logged in once this call returns.
     *
