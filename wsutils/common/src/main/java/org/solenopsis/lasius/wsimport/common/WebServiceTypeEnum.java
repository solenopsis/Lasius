package org.solenopsis.lasius.wsimport.common;
 ...
 * found here. Additionally, for the metadata service, and enterprise/partner
 * wsdls, we need the API version. For custom web service (developer written),
 * we need the name of the web service itself.
 *
 * The following table illustrates this: BASE URL SERVICE TYPE SUFFIX SPECIFIC
 * TO SERVICE https://test.salesforce.com services/Soap/m 21.0
 * https://login.salesforce.com services/Soap/c 22.0 https://test.salesforce.com
 * services/Soap/u 24.0 https://login.salesforce.com service/Soap/class FooAPI
 *
 * Examples: https://test.salesforce.com/services/Soap/m/21.0
 * https://login.salesforce.com/services/Soap/c/22.0
 * https://test.salesforce.com/services/Soap/u/24.0
 * https://test.salesforce.com/services/Soap/T/29.0
...
public enum WebServiceTypeEnum {
    ...
    TOOLING_SERVICE("services/Soap/T"),
     ...
     * @param prefix is the prefix to be first appended prior to self's string
     *               representation.
     */
     ...
     *
     * @param prefix is the prefix to emit when return the string representation
     *               of self.
     *
