...
public class InitialQuery<V> {
    ...
    /**
     * Initially when executing the SFDC query, this is the first batch of data
     * returned.
     */
     ...
     *
     * @throws IllegalArgumentException if queryResultLocator is null/empty or
     *                                  intialList is null.
     */
    public InitialQuery(final String queryResultLocator, final List<V> initialList) {
        IntegrityUtil.ensure(queryResultLocator, "Cannot have an empty or null query result locator!");
        IntegrityUtil.ensure(initialList, 0, "Cannot have a null initial list!");
