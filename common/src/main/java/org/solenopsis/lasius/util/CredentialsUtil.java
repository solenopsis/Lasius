...
public class CredentialsUtil {
    ...
    /**
     * Compute the web service password - this is a combination of
     * <code>password</code> plus <code>token</code>.
     *
    ...
    /**
     * Compute the web service password - this is a combination of credential's
     * <code>password</code> plus <code>token</code>.
     *
     * @param credentials contains the password and token for computation..
     *
     * @return the web service password (combination of credential's password
     *         plus token).
     */
