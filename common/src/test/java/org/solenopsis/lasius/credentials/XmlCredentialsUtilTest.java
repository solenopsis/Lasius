...
public class XmlCredentialsUtilTest {
    ...
    @Test
    public void test_singleEnumDefinedXmlConfiguration() {
        final Collection<Credentials> credsCollection = XmlCredentialsUtil.getCredentials(getClass().getClassLoader().getResource("singleEnumDefinedXmlConfiguration.xml"), "org");
    ...
    public void test_singleUserDefinedXmlConfiguration() {
        final Collection<Credentials> credsCollection = XmlCredentialsUtil.getCredentials(getClass().getClassLoader().getResource("singleUserDefinedXmlConfiguration.xml"), "org", "url", "user", "password", "token", "api");
        final Credentials[] creds = credsCollection.toArray(new Credentials[0]);
    ...
    @Test
    public void test_multipleEnumDefinedXmlConfiguration() {
        final Collection<Credentials> credsCollection = XmlCredentialsUtil.getCredentials(getClass().getClassLoader().getResource("mutlipleEnumDefinedXmlConfiguration.xml"), "orgs.org");
        final Credentials[] creds = credsCollection.toArray(new Credentials[0]);

        Assert.assertEquals("Should have 1 element", 3, creds.length);

        Assert.assertEquals("Should be same url", "http://theurl1", creds[0].getUrl());
        ...
        Assert.assertEquals("Should be same user name", "31.0", creds[0].getApiVersion());

        Assert.assertEquals("Should be same url", "http://theurl2", creds[1].getUrl());
        ...
        Assert.assertEquals("Should be same user name", "32.0", creds[1].getApiVersion());

        Assert.assertEquals("Should be same url", "http://theurl3", creds[2].getUrl());
        ...
        Assert.assertEquals("Should be same user name", "33.0", creds[2].getApiVersion());
    }

    @Test
    public void test_multipleUserDefinedXmlConfiguration() {
        final Collection<Credentials> credsCollection = XmlCredentialsUtil.getCredentials(getClass().getClassLoader().getResource("mutlipleUserDefinedXmlConfiguration.xml"), "orgs.org", "url", "user", "password", "token", "api");
        final Credentials[] creds = credsCollection.toArray(new Credentials[0]);
