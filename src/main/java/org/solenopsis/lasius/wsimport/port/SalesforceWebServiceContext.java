 ...
 *
 */
public class SalesforceWebServiceContext {
    /**
     ...
     */
    public <P> SalesforceWebServiceContext(final WebServiceTypeEnum webServiceType, final Service service, final Class<P> portType, String name, final SessionMgr sessionMgr) {
